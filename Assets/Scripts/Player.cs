...
public class Player : Actor {
    ...
    public override void Update() {
        base.Update();
        if (lastCheckedHealth != healthSystem.health || lastCheckedLevel != healthSystem.level || lastCheckedXp != healthSystem.xp || lastChechedShield != healthSystem.shield)
        {
            ...
            lastChechedShield = healthSystem.shield;
        }
    }
